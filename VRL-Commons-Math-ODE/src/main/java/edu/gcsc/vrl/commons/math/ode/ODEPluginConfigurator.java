 ...
 */
public class ODEPluginConfigurator extends VPluginConfigurator{

    public ODEPluginConfigurator() {
        //specify the plugin name and version
       setIdentifier(new PluginIdentifier("Commons-Math-ODE-Plugin", "0.1"));
